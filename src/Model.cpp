...
void Model::Render(const Shader& shader)
{
	...
	for (auto& buffer : m_buffers)
	{
		...
		buffer.LinkVBO(shader,
			"vertexIn", Buffer::VBOType::VERTEX_BUFFER, Buffer::ComponentType::XYZ, Buffer::DataType::FLOAT);
		buffer.LinkVBO(shader,
			"colorIn", Buffer::VBOType::COLOR_BUFFER, Buffer::ComponentType::RGBA, Buffer::DataType::FLOAT);
		buffer.LinkVBO(shader,
			"textureIn", Buffer::VBOType::TEXTURE_BUFFER, Buffer::ComponentType::UV, Buffer::DataType::FLOAT);
		buffer.LinkVBO(shader,
			"normalIn", Buffer::VBOType::NormalBuffer, Buffer::ComponentType::XYZ, Buffer::DataType::FLOAT);
...
void Model::FillBuffers()
{
	for (auto& mesh : m_meshes)
	{
		...
		buffer.FillVBO(Buffer::VBOType::VERTEX_BUFFER,
			&mesh.vertices[0].x, mesh.vertices.size() * sizeof(glm::vec3), Buffer::FillType::Once);

		buffer.FillVBO(Buffer::VBOType::TEXTURE_BUFFER,
		...
		buffer.FillVBO(Buffer::VBOType::COLOR_BUFFER,
